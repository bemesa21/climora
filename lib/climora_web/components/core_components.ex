defmodule ClimoraWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClimoraWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClimoraWeb.Gettext, "errors", msg, opts)
    end
  end
